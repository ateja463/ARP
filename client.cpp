...
/*void print(struct DNSPacket *dns)
{
	cout<<"query: "<<dns->website<<endl;
	cout<<"type: "<<dns->type<<endl;
	cout<<"ttl: "<<dns->ttl<<endl;
	cout<<"ipaddress: "<<dns->ipaddress<<endl;
	cour<<"length: "<<dns->length<<endl;
}*/
	...
	if(argc>=3)
	{
		...
		switch(opt)
		{
  			case 'h':
			{
				...
				//n=recv(sfd,dns,sizeof(DNSPacket),0);
				if(n==-1) break;
				cout<<"DNS Packet \n";
				write(1,buf,n);
				/*	
